    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 150 40'><text x='10' y='25' font-family='Arial, sans-serif' font-size='20' font-weight='bold' fill='%23ff6b35'>Disty</text><text x='70' y='25' font-family='Arial, sans-serif' font-size='14' fill='%231a365d'>Akademi</text></svg>" alt="Disty Akademi">
            </a>
                ...
                <div class="col-lg-6 hero-image text-center">
                    <div class="animate-float">
                        <div class="bg-white rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 300px; height: 300px;">
                            <i class="fas fa-user-graduate" style="font-size: 120px; color: var(--primary-orange) !important;"></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="program-card">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted mb-3">Intensive Live Class bersama Experts. Praktikal & Mendalam</p>
                            ...
                            <div class="col-md-4 text-center">
                                <div class="bg-light rounded-3 p-4 h-100 d-flex align-items-center justify-content-center">
                                    <i class="fas fa-laptop-code" style="font-size: 80px; color: var(--primary-orange);"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="program-card">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-center">
                                <div class="bg-light rounded-3 p-4 h-100 d-flex align-items-center justify-content-center">
                                    <i class="fas fa-certificate" style="font-size: 80px; color: var(--primary-orange);"></i>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <div class="mb-3">
                        <img src="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 150 40'><text x='10' y='25' font-family='Arial, sans-serif' font-size='20' font-weight='bold' fill='%23ff6b35'>Disty</text><text x='70' y='25' font-family='Arial, sans-serif' font-size='14' fill='white'>Akademi</text></svg>" alt="Disty Akademi" style="height: 40px;">
                    </div>
