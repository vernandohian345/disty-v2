...
@section('title', 'Disty Akademi - ' . $sertifikasi->nama_sertifikasi)
    ...
    <section class="course-detail-hero py-5 border-bottom">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <!-- Badge kategori -->
                    <span class="badge {{ $sertifikasi->kategori == 'gratis' ? 'bg-success' : 'bg-warning text-dark' }} mb-2 px-3 py-2">
                        <i class="fas fa-{{ $sertifikasi->kategori == 'gratis' ? 'check-circle' : 'tag' }} me-1"></i>
                        {{ ucfirst($sertifikasi->kategori) }}
                    </span>

                    <h2 class="fw-bold mb-3">{{ $sertifikasi->nama_sertifikasi }}</h2>

                    <ul class="list-unstyled mb-4">
                        <li class="mb-2">
                            <i class="far fa-calendar me-2 text-primary"></i>
                            <strong>Tanggal:</strong>
                            {{ \Carbon\Carbon::parse($sertifikasi->tanggal_sertifikasi)->translatedFormat('d F Y') }}
                        </li>
                        <li class="mb-2">
                            <i class="fa-solid fa-tag me-2 text-primary"></i>
                            <strong>Harga:</strong>
                            <span class="text-{{ $sertifikasi->kategori == 'gratis' ? 'success' : 'warning' }} fw-bold">
                        ...
                        <li class="mb-2">
                            ...
                            <strong>Durasi:</strong> {{ $sertifikasi->durasi }}
                        </li>
                        <li class="mb-2">
                            <i class="fa-solid fa-language me-2 text-primary"></i>
                            <strong>Bahasa:</strong> {{ $sertifikasi->bahasa }}
                        </li>
                    </ul>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="desc-block mb-4">
                        ...
                        <p class="text-muted">{{ $sertifikasi->deskripsi }}</p>
                    </div>
                    ...
                    <div class="desc-block mb-4">
                        ...
                        <img src="{{ asset('asset/contoh-sertifikat.png') }}"
                             alt="Contoh Sertifikat BNSP"
                             class="img-fluid rounded shadow">
                    </div>
                    ...
                    <div class="desc-block mb-4">
                        ...
                        <p class="text-muted mb-3">
                            Skema sertifikasi Digital Marketing BNSP mencakup <strong>Strategi, Eksekusi, dan Analisis</strong>.
                            Peserta akan diuji pada kompetensi inti seperti:
                        </p>
                        <ul class="checklist">
                            <li>
                                <i class="fa-regular fa-circle-check text-success"></i>
                                <strong>Pelaksanaan:</strong> Total 5 hari training dan sertifikasi. 4 Hari Training Online, dan 1 Hari Pelaksanaan Ujian Sertifikasi secara Online. Sehingga fleksibel dan dapat Anda ikuti dari mana saja.
                            </li>
                            <li>
                                <i class="fa-regular fa-circle-check text-success"></i>
                                <strong>Sertifikasi:</strong> Sertifikasi ini berbasis SKKNI No 38 Tahun 2019
                            </li>
                            <li>
                                <i class="fa-regular fa-circle-check text-success"></i>
                                <strong>Proses:</strong> Proses Sertifikasi dilakukan oleh Asesor berlisensi.
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="benefit-card shadow-sm">
                        ...
                        <ul class="benefit-list">
                            <li><i class="fa-solid fa-certificate text-warning"></i> Sertifikat resmi BNSP</li>
                            <li><i class="fa-solid fa-briefcase text-primary"></i> Diakui oleh industri & HRD perusahaan</li>
                            <li><i class="fa-solid fa-medal text-success"></i> Valid 3 tahun</li>
                            <li><i class="fa-solid fa-users text-info"></i> Uji kompetensi dengan asesor berlisensi</li>
                        </ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('transaksi.sertifikasi.store') }}" method="POST" id="formDaftar">
                        @csrf
                        ...
                        @if($sertifikasi->kategori == 'berbayar')
                            <div class="mb-3">
                                <label class="form-label">
    ...
    <section class="course-grid bg-light py-5">
        <div class="container">
            <h3 class="desc-title mb-4">
                ...
                Rekomendasi Sertifikasi Lainnya
            </h3>
            <div class="row g-4">
                @forelse($rekomendasi as $item)
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('sertifikasi.show', $item->slug) }}" class="course-link text-decoration-none">
                            <div class="course-card shadow-sm h-100">
                                ...
                                <div class="course-title p-3">
                                    <h5 class="mb-3">{{ $item->nama_sertifikasi }}</h5>
                    ...
                    html: `
                        <div class="text-center py-2">
                            ...
                            <a href="${link}" target="_blank"
                               class="btn btn-orange w-100 py-2 mt-2">
                    ...
                    html: `
                        <div class="text-center py-2">
                            ...
                            <p class="text-muted mb-3">
                                ...
                                untuk mengakses materi sertifikasi.
                            </p>
                            <hr>
