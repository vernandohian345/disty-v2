...
<div class="container-fluid p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold">Edit Pelatihan</h4>
            <p class="text-muted mb-0">Perbarui informasi pelatihan</p>
        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="kategori"
                                        ...
                                        <option value="gratis" {{ old('kategori', $pelatihan->kategori) == 'gratis' ? 'selected' : '' }}>Gratis</option>
                                        <option value="berbayar" {{ old('kategori', $pelatihan->kategori) == 'berbayar' ? 'selected' : '' }}>Berbayar</option>
                                    </select>
                                    @error('kategori')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="bahasa"
                                        ...
                                        <option value="Indonesia" {{ old('bahasa', $pelatihan->bahasa) == 'Indonesia' ? 'selected' : '' }}>Indonesia</option>
                                        <option value="English" {{ old('bahasa', $pelatihan->bahasa) == 'English' ? 'selected' : '' }}>English</option>
                                    </select>
                                    @error('bahasa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url"
                                           ...
                                           value="{{ old('link_grup', $pelatihan->link_grup) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="materi"
                                          ...
                                          rows="6"
                                          required>{{ old('materi', $pelatihan->materi) }}</textarea>
