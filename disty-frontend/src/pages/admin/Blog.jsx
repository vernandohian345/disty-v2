...
export default function Blog() {
  ...
  return (
    <AdminLayout>
      ...
      >
        <div>
          <h1 className="text-4xl font-black text-slate-800">Kelola Blog</h1>

          <p className="text-slate-500 mt-2">Manage seluruh data blog</p>
        </div>
    ...
    "
              ...
              <div>
                ...
                <input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    setForm({ ...form, sampul: e.target.files[0] })
                  }
                  className="w-full px-4 py-3 rounded-2xl border border-slate-200"
                />
                {editData?.sampul && (
